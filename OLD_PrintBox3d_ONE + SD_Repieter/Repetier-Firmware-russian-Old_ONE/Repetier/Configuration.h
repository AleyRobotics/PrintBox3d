...
#define XAXIS_STEPS_PER_MM 85.7143
#define YAXIS_STEPS_PER_MM 85.7143
#define ZAXIS_STEPS_PER_MM 85.7143
...
#define EXT0_STEPS_PER_MM 354	// Printbox big extruder with 64 microstepping driver
