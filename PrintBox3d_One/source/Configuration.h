...
// 8 is PrintBox3D One extruder thermistor
// 9 is PrintBox3D One bed thermistor
#define THERMISTORHEATER 8
#define THERMISTORBED 9

//// Calibration variables
// X, Y, Z, E steps per unit - Metric Prusa Mendel with Wade extruder:
#define _AXIS_STEP_PER_UNIT {86, 86, 86, 360}
...
//-----------------------------------------------------------------------
//Check the ways of your axis and set this Values
//-----------------------------------------------------------------------
...
#define _MAX_FEEDRATE {400, 400, 40, 10}       // (mm/sec)    
#define _HOMING_FEEDRATE {1500,1500,750}      // (mm/min) !!
