...
#if HAVE_HEATED_BED
#if NUM_EXTRUDER > 0
UI_PAGE4(ui_page1,cTEMP "%ec/%Ec\002" cDEG "B%eB/%Eb\002","Z:%x2  Buf : %oB","Mul: %om   Flow: %of","%os")
...
UI_MENU_ACTIONCOMMAND(ui_menu_setlang_tr, "\xc0\xe3\xe1\xe1\xda\xd8\xd9", UI_ACTION_LANGUAGE_TR | UI_ACTION_TOPMENU)
#if FIRSTLANG 
...
#define UI_MENU_LANGUAGES {UI_MENU_ADDCONDBACK ADD_LANG_EN ADD_LANG_TR ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL }
...
//UI_MENU_CHANGEACTION_T(ui_menu_off_apos, UI_TEXT_A_OFFSET_ID, UI_ACTION_XOFF)
//UI_MENU_CHANGEACTION_T(ui_menu_off_bpos, UI_TEXT_B_OFFSET_ID, UI_ACTION_XOFF)
#define UI_MENU_OFFSETS {UI_MENU_ADDCONDBACK &ui_menu_off_xpos}
UI_MENU(ui_menu_offsets, UI_MENU_OFFSETS, UI_MENU_BACKCNT + 1)
...
UI_MENU(ui_menu_positions, UI_MENU_POSITIONS, 6 + 3 * UI_SPEED + UI_MENU_BACKCNT + SERVOPOS_COUNT -1)
...
UI_MENU(ui_menu_positions, UI_MENU_POSITIONS, 3 + 3 * UI_SPEED + UI_MENU_BACKCNT + SERVOPOS_COUNT - 1)
#endif
...
//#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY UI_CHANGE_FIL_ENT,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
//#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY UI_CHANGE_FIL_ENT,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs}
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY UI_CHANGE_FIL_ENT,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick, UI_MENU_QUICK, 8 + BABY_CNT + UI_MENU_BACKCNT + MENU_PSON_COUNT + DEBUG_PRINT_COUNT + UI_TOGGLE_LIGHT_COUNT + UI_CHANGE_FIL_CNT - 4)
...
UI_MENU(ui_menu_fan, UI_MENU_FAN, 7 + UI_MENU_BACKCNT - 1)
...
UI_MENU(ui_menu_configuration, UI_MENU_CONFIGURATION, UI_MENU_BACKCNT + LANGMENU_COUNT + UI_MENU_EEPROM_CNT + UI_MENU_DELTA_CNT + UI_MENU_SL_CNT + 4)
// Main menu

//UI_MENU_SUBMENU_T(ui_menu_main01, UI_TEXT_CHANGE_FILAMENT_ID, ui_menu_quick_changefil)
UI_MENU_SUBMENU_T(ui_menu_main0, UI_TEXT_OFFSETS_ID,ui_menu_offsets)
...
#define UI_MENU_MAIN {UI_MENU_ADDCONDBACK  &ui_menu_main1, &ui_menu_main0, SD_PRINTFILE_ENTRY UI_MENU_SD_COND &ui_menu_quick_changefil, &ui_menu_main2,&ui_menu_main3,UI_MENU_FAN_COND &ui_menu_main5}
...
UI_MENU(ui_menu_main, UI_MENU_MAIN, 5 + UI_MENU_BACKCNT + UI_MENU_SD_CNT + UI_MENU_FAN_CNT + SD_PRINTFILE_ENTRY_CNT + 1)
