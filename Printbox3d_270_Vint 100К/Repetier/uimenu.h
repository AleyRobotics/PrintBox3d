...
*/
 ...
 //graphic main status
   ...
   UI_PAGE6(ui_page1,"\xa %e0/%E0\002 X:%x0",
   ...
   #else
    //	 "Flow:\xfd %of%%%   Z:%x2",
	 "\xbf\xde\xd4\xd0\xe7\xd0:\xfd %of%%% Z:%x2",
   #endif
   "\xc1\xda\xde\xe0.: %om%%% \xfd E: %x4m", "\xb1\xe3\xe4.: %oB", "%os")
 ...
 #if HAVE_HEATED_BED
 #if NUM_EXTRUDER > 0
//   UI_PAGE4(ui_page1,cTEMP "%ec/%Ec" "\002" "B%eB/%Eb" "\002","Z:%x2  Buf : %oB","Mul: %om   Flow: %of","%os")
//   UI_PAGE4(ui_page1,cTEMP "%ec/%Ec" "\002" "B%eB/%Eb" "\002","Z:%x2  Buf : %oB","Mul: %om   E:%x4","%os")
UI_PAGE4(ui_page1,cTEMP "%ec/%Ec" "\002" "B%eB/%Eb" "\002","Z:%x2 \xb1\xe3\xe4.  : %oB","\xbc\xdd\xde\xd6: %om   E:%x4","%os")
#else
//   UI_PAGE4(ui_page1,"B%eB/%Eb" "\002","Z:%x2  Buf : %oB","Mul: %om   Flow: %of","%os")
   //UI_PAGE4(ui_page1,"B%eB/%Eb" "\002","Z:%x2  Buf : %oB","Mul: %om   E:%x4","%os")
   UI_PAGE4(ui_page1,"B%eB/%Eb" "\002","Z:%x2  \xb1\xe3\xe4. : %oB","\xc1\xda\xde\xe0.: %om   E:%x4","%os")
#endif
   //UI_PAGE4(ui_page1,UI_TEXT_PAGE_EXTRUDER,UI_TEXT_PAGE_BED,UI_TEXT_PAGE_BUFFER,"%os");
 #else
 #if NUM_EXTRUDER > 0
   UI_PAGE4(ui_page1,UI_TEXT_PAGE_EXTRUDER,"Z:%x2 \xdc\xdc",UI_TEXT_PAGE_BUFFER,"%os")
   #else
   UI_PAGE4(ui_page1,"","Z:%x2 \xdc\xdc",UI_TEXT_PAGE_BUFFER,"%os")
   #endif
 #endif
 UI_PAGE4(ui_page2,"X:%x0 \xdc\xdc","Y:%x1 \xdc\xdc","Z:%x2 \xdc\xdc","%os")
...
//UI_PAGE4(ui_page2,"dX:%y0 mm %sX","dY:%y1 mm %sY","dZ:%y2 mm %sZ","%os");
 ...
 #if EEPROM_MODE != 0
  UI_PAGE4(ui_page4,UI_TEXT_PRINT_TIME,"%Ut",UI_TEXT_PRINT_FILAMENT,"%Uf \xdc")
...
UI_PAGE2(ui_page3,"Z:%x2 \xdc\xdc","%os")
/*
Merge pages together. Use the following pattern:
#define UI_PAGES {&name1,&name2,&name3}
*/
...
UI_WIZARD4(ui_wiz_jamwaitheat, UI_ACTION_WIZARD_JAM_WAITHEAT, UI_TEXT_WIZ_WAITTEMP1, UI_TEXT_WIZ_WAITTEMP2,"",cTEMP "%ec/%Ec" "\002")
UI_WIZARD4(ui_wiz_jamreheat, UI_ACTION_WIZARD_JAM_REHEAT, UI_TEXT_WIZ_REHEAT1, UI_TEXT_WIZ_REHEAT2,"",cTEMP "%ec" "\002")
#else
...
UI_MENU_ACTION4C(ui_menu_extrtemp,UI_ACTION_EXTRUDER0_TEMP,"Temp. 0  :%E0" "\002","","","");
