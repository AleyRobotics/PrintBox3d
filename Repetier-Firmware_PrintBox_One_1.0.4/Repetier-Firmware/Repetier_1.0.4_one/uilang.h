...
#if NUM_EXTRUDER > 2 || MIXING_EXTRUDER != 0
#define UI_TEXT_MAINPAGE6_1_RU "\xa %ec/%Ec\x2 X:%x0"
#else
...
#elif HAVE_HEATED_BED
#define UI_TEXT_MAINPAGE6_2_RU "\xe %eb/%Eb\x2 Y:%x1"
#else
...
#else
#define UI_TEXT_MAINPAGE6_3_RU "\277\336\342\336\332:\xfd %of%%%   Z:%x2"
#endif
